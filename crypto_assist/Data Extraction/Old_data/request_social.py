...
url= 'https://min-api.cryptocompare.com/data/social/coin/histo/day?&coinId=7605&limit=1&api_key=ec6ccfef0683ed17b8dea49e01c0954abcd030ba0dd27eb704d1c829dead85e6'
r = requests.get(url)
data = r.json()
